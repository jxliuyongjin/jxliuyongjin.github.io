import{_ as e,o as d,c as a,b as i}from"./app-2fab46b3.js";const r={},n=i(`<h4 id="目标" tabindex="-1"><a class="header-anchor" href="#目标" aria-hidden="true">#</a> 目标</h4><p><strong>这是一个实例，目标是制作一个ubuntu镜像，此镜像里有添加默认没有的vim编辑器，并把他添加添加到阿里云</strong></p><h3 id="一、制作容器" tabindex="-1"><a class="header-anchor" href="#一、制作容器" aria-hidden="true">#</a> 一、制作容器</h3><h5 id="_1、制作容器" tabindex="-1"><a class="header-anchor" href="#_1、制作容器" aria-hidden="true">#</a> 1、制作容器</h5><p>拉取官方的ubuntu，并制作成容器</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker run -it --name=myubuntu ubuntu /bin/bash
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_2、运行本地私有仓库" tabindex="-1"><a class="header-anchor" href="#_2、运行本地私有仓库" aria-hidden="true">#</a> 2、运行本地私有仓库</h5><p>相当于本地有个私有Docker hub</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker run -d -p 5000:5000 -v /zzyyuse/myregistry/:/tmp/registry --privileged=true registry
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_3、curl测验证私服库上有是否有镜像" tabindex="-1"><a class="header-anchor" href="#_3、curl测验证私服库上有是否有镜像" aria-hidden="true">#</a> 3、curl测验证私服库上有是否有镜像</h5><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>[root@VM-12-17-centos ~]# curl -XGET http://1.116.82.74:5000/v2/_catalog
{&quot;repositories&quot;:[]}//私服库没有镜像
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_4、在做一个镜像" tabindex="-1"><a class="header-anchor" href="#_4、在做一个镜像" aria-hidden="true">#</a> 4、在做一个镜像</h5><p>做法同上</p><h5 id="_5、修改images格式" tabindex="-1"><a class="header-anchor" href="#_5、修改images格式" aria-hidden="true">#</a> 5、修改images格式</h5><p>使用docker tag 将ubuntu这个镜像克隆并改名改为1.116.82.74:5000/ubuntu:1.1</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker tag ubuntu:1.1 1.116.82.74:5000/ubuntu:1.1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_6、修改配置文件" tabindex="-1"><a class="header-anchor" href="#_6、修改配置文件" aria-hidden="true">#</a> 6、修改配置文件</h5><p>修改配置文件，使得docker 支持http推送</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>vim /etc/docker/daemon.json
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="_7、把image推送到私服库" tabindex="-1"><a class="header-anchor" href="#_7、把image推送到私服库" aria-hidden="true">#</a> 7、把image推送到私服库</h5><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker push 1.116.82.74:5000/ubuntu:1.1
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h5 id="_8、测试" tabindex="-1"><a class="header-anchor" href="#_8、测试" aria-hidden="true">#</a> 8、测试</h5><p>8.1、先测验证私服库上有是否有镜像</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>[root@VM-12-17-centos /]# curl -XGET http://1.116.82.74:5000/v2/_catalog
{&quot;repositories&quot;:[&quot;ubuntu&quot;]}
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>8.2、从私服库拉取镜像</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>[root@VM-12-17-centos /]# docker pull 1.116.82.74:5000/ubuntu:1.1
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>可以看出里面是有b.txt的，这样小组其他成员也可以用相同的方式，拉去你的镜像啦</p>`,62),s=[n];function c(o,t){return d(),a("div",null,s)}const u=e(r,[["render",c],["__file","3、自定义镜像.html.vue"]]);export{u as default};
