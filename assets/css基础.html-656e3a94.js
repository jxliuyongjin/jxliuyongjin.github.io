import{_ as n,o as s,c as a,b as e}from"./app-05941657.js";const i={},t=e(`<h2 id="_1、样式表的优先级" tabindex="-1"><a class="header-anchor" href="#_1、样式表的优先级" aria-hidden="true">#</a> 1、样式表的优先级</h2><ul><li><strong>!important;</strong>&gt;行内样式&gt;id选择器&gt;类选择器&gt;元素选择器&gt;通配选择&gt;继承的样式</li><li>同一种选择器之间后面写得会覆盖前面得样式</li><li>复合选择器，权重高的优先，权重值按第一项的规则，相同的情况会覆盖掉之前的(a,b,c) <ul><li>id选择器(1,0,0)</li><li>类选择器(0,1,0)</li><li>元素选择器(0,1,0)</li><li>通配选择(0,0,0)</li></ul></li></ul><h2 id="_2、css语法" tabindex="-1"><a class="header-anchor" href="#_2、css语法" aria-hidden="true">#</a> 2、css语法</h2><p><img src="https://atts.w3cschool.cn/attachments/image/20230921/1695309763545831.png" alt="css语法"></p><h3 id="_2-1、选择器" tabindex="-1"><a class="header-anchor" href="#_2-1、选择器" aria-hidden="true">#</a> 2.1、选择器</h3><p>基本选择器包括：</p><h4 id="_1、通配选择器" tabindex="-1"><a class="header-anchor" href="#_1、通配选择器" aria-hidden="true">#</a> 1、通配选择器</h4><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">//语法
...
div{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>行的水平位置：</p><ul><li>默认基线对齐</li><li>middle时，对齐的是自身往行基线上移自身高度的一半</li><li>行的高度，由本行最高的决定</li><li>不能直接控制自身元素里的文字，它控制的是自身相对父级元素的行内位置</li><li>不能控制块级元素，只能控制行内元素在本行的位置</li></ul><h3 id="_3-3、列表" tabindex="-1"><a class="header-anchor" href="#_3-3、列表" aria-hidden="true">#</a> 3.3、列表</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">ul</span><span class="token punctuation">{</span>

    <span class="token comment">/* 列表符号 none是取消前面的字符 */</span>
    <span class="token property">list-style-type</span><span class="token punctuation">:</span>disc<span class="token punctuation">;</span>
   <span class="token comment">/* 列表符号是在li的里面还是在外面 */</span>
   ...
   <span class="token comment">/* 自定义，用一张图片代替列表字符 */</span>
   <span class="token property">list-style-image</span><span class="token punctuation">:</span> <span class="token url"><span class="token function">url</span><span class="token punctuation">(</span><span class="token string url">&quot;./1.png&quot;</span><span class="token punctuation">)</span></span><span class="token punctuation">;</span>
    <span class="token comment">/* 复合属性 */</span>
    <span class="token property">list-style</span><span class="token punctuation">:</span> disc outside <span class="token url"><span class="token function">url</span><span class="token punctuation">(</span><span class="token string url">&quot;./1.png&quot;</span><span class="token punctuation">)</span></span><span class="token punctuation">;</span> 
<span class="token punctuation">}</span>
&lt;ul&gt;
  &lt;li&gt;我是第1名&lt;/li&gt; 
  &lt;li&gt;我是第2名&lt;/li&gt; 
  ...
  &lt;li&gt;我是第4名&lt;/li&gt;  
&lt;/ul&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-4、边框" tabindex="-1"><a class="header-anchor" href="#_3-4、边框" aria-hidden="true">#</a> 3.4、边框</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code> <span class="token selector">table</span><span class="token punctuation">{</span>  
    <span class="token comment">/* 单独写一个没效果 */</span>
    <span class="token comment">/* border-width: 3px; */</span>
    <span class="token comment">/* 边框的颜色 */</span>
    <span class="token comment">/* border-color:greenyellow; */</span>
    <span class="token comment">/* 边框是实线虚线还是点线。。 */</span>
    <span class="token comment">/* border-style: solid; */</span>
    <span class="token comment">/* 复合 */</span>
    <span class="token property">border</span><span class="token punctuation">:</span>3px green solid
<span class="token punctuation">}</span>
<span class="token selector">td,th</span><span class="token punctuation">{</span>
    <span class="token property">border</span><span class="token punctuation">:</span> 2px orange solid<span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-5、表格" tabindex="-1"><a class="header-anchor" href="#_3-5、表格" aria-hidden="true">#</a> 3.5、表格</h3><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code> <span class="token selector">&lt;style&gt; 
    table</span><span class="token punctuation">{</span> 
        <span class="token property">width</span><span class="token punctuation">:</span> 500px<span class="token punctuation">;</span> 
        <span class="token property">border</span><span class="token punctuation">:</span>3px green solid<span class="token punctuation">;</span>
        <span class="token comment">/* 控制表格的宽 */</span>
        <span class="token property">table-layout</span><span class="token punctuation">:</span>fixed<span class="token punctuation">;</span>
        <span class="token comment">/* 控制单元格间距 */</span>
        <span class="token property">border-spacing</span><span class="token punctuation">:</span> 30px<span class="token punctuation">;</span>
        <span class="token comment">/* 合并相邻的单元格 的边框
        如果这个属性设置了，border-spacing就失效了
        */</span>
        <span class="token property">border-collapse</span><span class="token punctuation">:</span> collapse<span class="token punctuation">;</span>
        <span class="token comment">/* 隐藏没内容的表格 */</span>
        <span class="token property">empty-cells</span><span class="token punctuation">:</span> hide<span class="token punctuation">;</span>
        <span class="token comment">/* 中对齐 */</span>
        <span class="token property">text-align</span><span class="token punctuation">:</span> center<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token selector">td,th</span><span class="token punctuation">{</span>
        <span class="token property">border</span><span class="token punctuation">:</span> 2px orange solid<span class="token punctuation">;</span>
