import{_ as e,o as d,c as a,b as i}from"./app-3bad0daf.js";const r={},n=i(`<h4 id="目标" tabindex="-1"><a class="header-anchor" href="#目标" aria-hidden="true">#</a> 目标</h4><p><strong>这是一个实例，目标是制作一个ubuntu镜像，此镜像里有添加默认没有的vim编辑器，并把他添加添加到阿里云</strong></p><h3 id="一、制作容器" tabindex="-1"><a class="header-anchor" href="#一、制作容器" aria-hidden="true">#</a> 一、制作容器</h3><h4 id="_1、制作容器" tabindex="-1"><a class="header-anchor" href="#_1、制作容器" aria-hidden="true">#</a> 1、制作容器</h4><p>拉取官方的ubuntu，并制作成容器</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker run -it --name=myubuntu ubuntu /bin/bash
