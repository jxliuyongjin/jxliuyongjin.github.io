import{_ as s,o as e,c as n,b as a}from"./app-241ee0f8.js";const i={},l=a(`<h3 id="一、配置修改" tabindex="-1"><a class="header-anchor" href="#一、配置修改" aria-hidden="true">#</a> 一、配置修改</h3><h4 id="_1、主服务器配置" tabindex="-1"><a class="header-anchor" href="#_1、主服务器配置" aria-hidden="true">#</a> 1、主服务器配置</h4><h5 id="_1-1、创建实例" tabindex="-1"><a class="header-anchor" href="#_1-1、创建实例" aria-hidden="true">#</a> 1.1、创建实例</h5><p>//使用数据卷备份数据库</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker run -d -p 3306:3306 --name=sql-master \\
