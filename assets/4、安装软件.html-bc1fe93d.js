import{_ as e,o as a,c as i,b as s}from"./app-09fca0e8.js";const d={},n=s(`<h3 id="一、tomcat安装" tabindex="-1"><a class="header-anchor" href="#一、tomcat安装" aria-hidden="true">#</a> 一、tomcat安装</h3><h4 id="_1、安装" tabindex="-1"><a class="header-anchor" href="#_1、安装" aria-hidden="true">#</a> 1、安装</h4><p>直接安装，如果本地没有会自动下载官网的镜像</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker run -d -p 8080:8080 --name t1 tomcat
