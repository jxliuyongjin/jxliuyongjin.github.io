import{_ as n,o as s,c as a,b as e}from"./app-09fca0e8.js";const i={},t=e(`<h2 id="_1、样式表的优先级" tabindex="-1"><a class="header-anchor" href="#_1、样式表的优先级" aria-hidden="true">#</a> 1、样式表的优先级</h2><ul><li><strong>!important;</strong>&gt;行内样式&gt;id选择器&gt;类选择器&gt;元素选择器&gt;通配选择&gt;继承的样式</li><li>同一种选择器之间后面写得会覆盖前面得样式</li><li>复合选择器，权重高的优先，权重值按第一项的规则，相同的情况会覆盖掉之前的(a,b,c) <ul><li>id选择器(1,0,0)</li><li>类选择器(0,1,0)</li><li>元素选择器(0,1,0)</li><li>通配选择(0,0,0)</li></ul></li></ul><h2 id="_2、css语法" tabindex="-1"><a class="header-anchor" href="#_2、css语法" aria-hidden="true">#</a> 2、css语法</h2><p><img src="https://atts.w3cschool.cn/attachments/image/20230921/1695309763545831.png" alt="css语法"></p><h3 id="_2-1、选择器" tabindex="-1"><a class="header-anchor" href="#_2-1、选择器" aria-hidden="true">#</a> 2.1、选择器</h3><p>基本选择器包括：</p><h4 id="_1、通配选择器" tabindex="-1"><a class="header-anchor" href="#_1、通配选择器" aria-hidden="true">#</a> 1、通配选择器</h4><div class="language-css line-numbers-mode" data-ext="css"><pre class="language-css"><code><span class="token selector">//语法
